...
1. **Affine transformations** If $$y = Ax+b$$ and $$x \sim \mathcal{N}(\mu, \Sigma)$$, then 

$$
y \sim \mathcal{N}(A\mu+b, A\Sigma A^{\top})
$$.

1. **Marginal and conditional** A joint Gaussian remains Gaussian under marginalization and conditioning.

2. **MLE for mean and covariance** Given $$\{x_n\}_{n=1}^N$$ i.i.d. from a Gaussian,
